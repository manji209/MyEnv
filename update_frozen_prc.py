...
file_name = "Data/frozen_update_prc.xlsx"
...
sqlstring = "UPDATE dbo.IHSLIN00 SET unit_cost=? WHERE item_no=? AND DATEPART(YEAR, invc_dat)=?"

yr = 2018

for index, row in df.iterrows():
    values = [row.new_price, row.item_no, yr]
    try:

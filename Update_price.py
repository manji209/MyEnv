...
book = xlrd.open_workbook("Data/Update_Price.xlsx")
...
sqlupdate = "UPDATE dbo.ITMFIL00 SET item_prc_1=?, replacement_cost=? WHERE item_no=?"
...
for r in range(1, sheet.nrows):
    ...
    cost = sheet.cell(r,2).value

    values = [prc, cost, item_no]
